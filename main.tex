...
\title{Arrastre de herbicida 2,4-D en agua usando nanotubos de carbono (6,5)}         % Título de la tesis
\asesor{Dra. Minerva González Melchor}               % Nombre del asesor
\presidente{Dra. Honorina Ruíz Estrada} % Nombre del presidente del jurado
\secretario{Dr. Eduardo González Jiménez}       % Nombre del secretario del jurado
\vocala{Dra. Lorena Romero Salazar}         % Nombre del 1er vocal del jurado
